...
@section('content')
    ...
    <div class="container py-4">
        ...
        <p class="text-muted mb-4">Perbarui data siswa</p>
        ...
        <div class="form-wrapper">
            <div class="card-form">
                ...
                <div class="card-header-soft d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="fw-semibold">Informasi Siswa</div>
                        <small class="text-muted">Lengkapi data siswa dengan benar</small>
                    </div>
                </div>
                ...
                <form action="{{ route('siswa.update', $siswa->id) }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="small fw-semibold">Sekolah Asal</label>
                            <input type="text" name="sekolah" class="form-control" value="{{ $siswa->sekolah }}">
                        </div>

                        <div class="col-md-6">
                            <label class="small fw-semibold">No. Telepon Ortu</label>
                            <input type="text" name="no_telp_ortu" class="form-control" value="{{ $siswa->no_telp_ortu }}">
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <label class="small fw-semibold">Tanggal Lahir</label>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <a href="{{ route('siswa.index') }}" class="btn btn-light rounded-pill px-4">
                            Batal
                        </a>
